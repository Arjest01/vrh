    ...
    <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <h1 class="text-base font-semibold leading-7 text-gray-900">Créer un poste</h1>
                ...
                <div class="mt-10 space-y-8 md:w-2/3">
                    ...
                    <x-input name="slug" label="Slug" help="Laisser vide pour un slug auto. Si une valeur est enseigné elle sera slugifiée avant d'ètre soumise à validation."/>
